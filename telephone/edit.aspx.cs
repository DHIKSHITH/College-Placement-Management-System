...
namespace telephone
{
    public partial class edit : System.Web.UI.Page
    {
        ...
        protected void b1_Click(object sender, EventArgs e)
        {
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "update add_data set usn='"+usn.Text+"',name='"+name.Text+"',branch='"+branch.Text+"',company_name='"+company_name.Text+"',designation='"+designation.Text+"',package='"+package.Text+ "'where id=" + id+"";
            cmd.ExecuteNonQuery();
