<%@ Page Title="" Language="C#" MasterPageFile="~/ent.Master" AutoEventWireup="true" CodeBehind="ent2.aspx.cs" Inherits="telephone.ent2" %>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                 ...
                                 <a href="ent3.aspx?id=<%#Eval("id")%>"</a><img src="assets/images/edit.png" height="50" width="50" />
                                 <a href="entdel.aspx?id=<%#Eval("id")%>"</a><img src="assets/images/delete.png" height="50" width="50" /></a>  
                                </td>
