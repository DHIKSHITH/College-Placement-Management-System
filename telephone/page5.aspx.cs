...
namespace telephone
{
    public partial class page5 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from hg where id=" + id + "";
            cmd.ExecuteNonQuery();
        ...
        protected void b1_Click(object sender, EventArgs e)
        {
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "update hg set usn='" + usn.Text + "',name='" + name.Text + "',branch='" + branch.Text + "',gre='" + gre.Text + "',course='" + course.Text + "',university_name='" + university_name.Text + "',university_address='" + university_address.Text + "',email='" + email.Text + "'where id=" + id + "";
            cmd.ExecuteNonQuery();
