<%@ Page Title="" Language="C#" MasterPageFile="~/hg3.Master" AutoEventWireup="true" CodeBehind="page4_3.aspx.cs" Inherits="telephone.page4_3" %>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                 ...
                                 <a href="page5_3.aspx?id=<%#Eval("id")%>"</a><img src="assets/images/edit.png" height="50" width="50" />
                                 <a href="hgdel3.aspx?id=<%#Eval("id")%>"</a><img src="assets/images/delete.png" height="50" width="50" /></a>  
                                </td>
