<%@ Page Title="" Language="C#" MasterPageFile="~/user3.Master" AutoEventWireup="true" CodeBehind="mydata3.aspx.cs" Inherits="telephone.mydata3" %>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                 ...
                                 <a href="edit3.aspx?id=<%#Eval("id")%>"</a><img src="assets/images/edit.png" height="50" width="50" />
                                 <a href="delete3.aspx?id=<%#Eval("id")%>"</a><img src="assets/images/delete.png" height="50" width="50" /></a>  
                                </td>
